...
import com.bangkit.storyapp.databinding.ActivityCameraBinding
import com.bangkit.storyapp.utils.createFile
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onError(exception: ImageCaptureException) {
                    Toast.makeText(this@CameraActivity, getString(R.string.take_picture_failed), Toast.LENGTH_SHORT).show()
                }
